<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Contraseña | *debe de tener un mínimo de 8 carácteres') }}
            ...
            <div class="col-md-12">
                <div class="alert alert-warning text-center mt-4" role="alert">
                    <label for=""><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                        ...
                        </svg>Contraseña debe ser del mínimo de 8 carácteres, ya seán números, letras o cáracteres especiales.</label>
                </div>
            </div>
        </div>
    </div>
...
<div class="box-footer mt20 text-center">
    ...
    <!--
            <button type="submit" class="btn btn-primary mt-3"> <i class="fa fa-save" style="margin-right: 3px;"></i>{{ __('Registrar') }}</button>
        -->
</div>
</div>