    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="card cabecera1 card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hipotecarios.store') }}" role="form" enctype="multipart/form-data">
                        @csrf

                        @include('hipotecario.form')
