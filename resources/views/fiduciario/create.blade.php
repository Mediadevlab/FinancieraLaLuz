...
<section class="py-4 container mt-3">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <h3 class="marco"><i class="fa fa-briefcase"><b></i> Crear Cliente y Aval</h3></b>
            <div class="card cabecera1 card-default">
                <div class="card-header cabecera2" style="border-top: solid 4px green;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span id="card_title">
                            {{ __('Formulario de creación de Cliente y del Aval') }}
                        </span>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('fiduciarios.store') }}" role="form" enctype="multipart/form-data">
                        @csrf
