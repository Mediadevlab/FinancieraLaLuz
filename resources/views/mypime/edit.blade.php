    ...
    <div class="">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div style="display: flex; justify-content: space-between;" class="marco">
                <h3 class=""><i class="fa fa-pencil"><b></i> Actualización de Cliente</h3></b>
            ...
            <div class="card cabecera1 card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('mypimes.update', $mypime->id) }}" role="form" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        @csrf
